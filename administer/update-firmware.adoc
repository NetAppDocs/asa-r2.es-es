...
Desactiva las actualizaciones automáticas solo si quieres gestionar las actualizaciones completamente por tu cuenta. Con las actualizaciones automáticas desactivadas, el sistema no notificará, descargará ni instalará actualizaciones. Tú eres responsable de supervisar, descargar, programar e instalar todas las actualizaciones manualmente.
