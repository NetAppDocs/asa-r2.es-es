...
== Habilite ARP/AI en todas las unidades de almacenamiento de una máquina virtual de almacenamiento.
...
== Habilite ARP/AI en unidades de almacenamiento específicas de una máquina virtual de almacenamiento.

Si no desea que ARP/AI esté habilitado en todas las unidades de almacenamiento de una máquina virtual de almacenamiento, puede seleccionar las unidades específicas que desea habilitar.
