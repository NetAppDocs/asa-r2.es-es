...
Si necesita cambiar del gestor de claves incorporado a un gestor de claves externo o viceversa, consulte link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/migrate-keys-between-key-managers["Migrar las claves de cifrado de datos de ONTAP entre gestores de claves"^].
