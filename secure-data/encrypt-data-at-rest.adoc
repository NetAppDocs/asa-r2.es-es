...
Además de NSE, también puedes activar el cifrado por software para añadir otra capa de seguridad a tus datos. Los sistemas ASA r2 utilizan la tecnología NetApp Volume Encryption (NVE) para cifrar los datos a nivel de software. NetApp Aggregate Encryption (NAE) no es compatible con los sistemas ASA r2 porque la capa de almacenamiento en los sistemas ASA r2 utiliza zonas de disponibilidad de almacenamiento en lugar de agregados.

Más información sobre link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/configure-netapp-volume-encryption-concept.html["Cifrado de volumen de NetApp"^].

Más información sobre link:https://docs.netapp.com/us-en/asa-r2/learn-more/hardware-comparison.html["las diferencias entre los sistemas ASA r2 y otros sistemas ONTAP"].
