...
---
= Responde a la protección autónoma contra ransomware con alertas de IA en los sistemas de almacenamiento ASA r2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Si sabes de aumentos repentinos en la actividad de tu unidad de almacenamiento, ya sea un aumento puntual o uno que sea característico de una nueva normalidad, deberías reportarlos como seguros. Reportar manualmente estos aumentos como seguros ayuda a mejorar la precisión de las evaluaciones de amenazas de ARP. Aprende cómo link:https://docs.netapp.com/us-en/ontap/anti-ransomware/manage-parameters-task.html#report-known-surges["informar los aumentos de ARP/AI conocidos"^].
