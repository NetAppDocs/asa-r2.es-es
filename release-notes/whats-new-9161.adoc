...
| Plataformas  a| 
Los siguientes sistemas NetApp ASA r2 son compatibles a partir de ONTAP 9.16.1.  Estas plataformas ofrecen una solución unificada de hardware y software que crea una experiencia simplificada específica para las necesidades de los clientes que solo utilizan SAN.
