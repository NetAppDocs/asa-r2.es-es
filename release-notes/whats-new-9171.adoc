...
| link:../administer/space-balancing.html["Soporte para equilibrio automático de carga de trabajo"] | Las cargas de trabajo se equilibran automáticamente entre los nodos de un par de alta disponibilidad para optimizar el rendimiento y la utilización de recursos. 
|===