...
** Para los sistemas de almacenamiento ASAr2 A20, A30 o A50, la pantalla de ID de bandeja en la parte frontal del chasis del sistema no se enciende. El ID de bandeja interna del sistema está fijado en 00.
