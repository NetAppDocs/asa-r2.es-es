...
summary: Conecta el sistema de almacenamiento ASA A20, ASA A30 o ASA A50 a tu red y a las estanterías de almacenamiento para habilitar la comunicación del clúster, el acceso de gestión y la conectividad de host SAN. 
---
= Conecta el hardware de los sistemas de almacenamiento ASA A20, ASA A30 y ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta el sistema de almacenamiento ASA A20, ASA A30 o ASA A50 a tu red y a los estantes de almacenamiento para habilitar la comunicación del clúster, el acceso de gestión y la conectividad de host SAN. Este procedimiento incluye el cableado para la interconexión de clúster/HA, la red de gestión, la red de host y las conexiones de estantes de almacenamiento.
...
+
image::../media/drw_isi_a20_switchless_2p_25gbe_cabling_ieops-2018.svg[Diagrama de cableado de clúster sin switches ASA A20 con un módulo de E/S de 25 GbE]
...
+
image::../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg[Diagrama de cableado del clúster conmutado ASA A20 usando un módulo de E/S de 25 GbE]
...
.ASA A30 o ASA A50 con dos módulos de I/O de 40/100 GbE con 2 puertos
Usa los puertos e2b y e4b de cada controlador para conectarte a los switches de red host Ethernet.
...
.ASA A20, A30 o A50 con un módulo de E/S 10/25 GbE de 4 puertos
Usa los cuatro puertos del módulo de E/S de la ranura 2 para conectarte a los switches de red host Ethernet.
...
.ASA A20, A30 o A50 con un módulo de E/S FC de 4 puertos a 64 Gb/s
Usa los cuatro puertos del módulo de E/S FC de la ranura 2 para conectarte a los switches de red de host FC.
