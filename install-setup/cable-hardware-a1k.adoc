...
summary: Conecta el sistema de almacenamiento ASA A1K a tu red y a las estanterías de almacenamiento para habilitar la comunicación del clúster, el acceso de gestión y la conectividad de host SAN. 
---
= Conecta el hardware para el sistema de almacenamiento ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta el sistema de almacenamiento ASA A1K a tu red y a las bandejas de almacenamiento para habilitar la comunicación del clúster, el acceso de gestión y la conectividad de host SAN. Este procedimiento incluye el cableado para la interconexión de clúster/HA, la red de gestión, la red de host y las conexiones de bandejas de almacenamiento.
...
* Las ranuras de E/S del ASA A1K están numeradas del 1 al 11.
+
image::../media/drw_a1K_back_slots_labeled_ieops-2162.svg[Numeración de ranuras en un controlador ASA A1K]
...
+
image::../media/drw_a1k_network_cabling1_ieops-1649.svg[Cable a red Ethernet de 100 GbE]
...
image::../media/oie_cable_sfp_gbe_copper.svg[cable Ethernet 10/25 GbE]

image::../media/drw_a1k_network_cabling2_ieops-1650.svg[Cable a red Ethernet 10/25 GbE]
...
Los sistemas de almacenamiento ASA A1K admiten estanterías NS224 con el módulo NSM100 o NSM100B. Las principales diferencias entre los módulos son:
...
.. Conecta el puerto e11b al puerto e0b del NSM B.
+
...
.. Conecta el puerto e10b al puerto e0b del NSM B del shelf 1.
+
