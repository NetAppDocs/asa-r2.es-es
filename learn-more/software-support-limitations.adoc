...
+
Los sistemas ASA r2 admiten el cifrado por hardware mediante unidades de cifrado automático (SED) y el cifrado por software mediante la tecnología NetApp Volume Encryption (NVE). link:../secure-data/encrypt-data-at-rest.html["Aprenda a aplicar el cifrado de doble capa"] a los datos en tu sistema ASA r2.
