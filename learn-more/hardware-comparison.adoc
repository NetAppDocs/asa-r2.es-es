...
Cuando se crea una unidad de almacenamiento (basada en un LUN o en un espacio de nombres NVMe), ONTAP crea automáticamente un volumen en la zona de disponibilidad de almacenamiento adecuada para alojar la unidad de almacenamiento. El volumen recién creado se coloca automáticamente dentro de la zona de disponibilidad de almacenamiento para obtener un rendimiento óptimo y un uso equilibrado de la capacidad. El uso de la capacidad se equilibra dentro de la zona de disponibilidad de almacenamiento en función de tu versión de ONTAP. link:../administer/space-balancing.html["Obtenga información sobre el equilibrio de capacidad en un clúster ASA r2"^].
