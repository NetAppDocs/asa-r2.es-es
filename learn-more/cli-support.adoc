...
A menos que se indique que no son compatibles, todos los demás comandos en el link:https://docs.netapp.com/us-en/ontap-cli/["Referencia de comandos del ONTAP"] son compatibles con los sistemas ASA r2.
