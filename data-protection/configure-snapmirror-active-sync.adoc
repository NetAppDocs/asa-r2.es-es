...
Si utiliza el protocolo iSCSI o FC y utiliza herramientas ONTAP para VMware Sphere, puede opcionalmente link:https://docs.netapp.com/us-en/netapp-solutions/vmware/vmware-vmsc-with-smas.html["Utilice ONTAP Tools para VMware para configurar la sincronización activa de SnapMirror"^] .


NOTE: A partir de ONTAP 9.19.1, la Protección Autónoma contra Ransomware con Inteligencia Artificial (ARP/AI) es compatible con las unidades de almacenamiento primarias de lectura y escritura en relaciones SAN de sincronización activa de SnapMirror en sistemas ASA r2. ARP/AI se ejecuta en las unidades de almacenamiento primario activas, crea instantáneas ARP solo para el almacenamiento primario y ofrece detección de ransomware basada en aprendizaje automático para esas unidades de almacenamiento. Para habilitar ARP/AI, consulta link:../secure-data/enable-anti-ransomware-protection.html["Activa la protección autónoma contra el ransomware con IA"].
