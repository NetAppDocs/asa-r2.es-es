...
summary: 'Los sistemas R2 de ASA (ASA A1K, A90, A70, A50, A30, A20) ofrecen una solución unificada de hardware y software para una experiencia simplificada para clientes de SAN.' 
searchtitle: Obtenga más información sobre los sistemas ASA A1K, A90, A70, A50, A30 y A20 
---
